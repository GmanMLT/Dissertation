...
dfperformancemetrics = pd.read_csv('/content/dfperformancemetrics.csv', index_col =0)
dfperformanceacc = pd.read_csv('/content/dfperformanceacc.csv', index_col =0)
...
if page == "Disclaimer":
   ...
   #       st.header("About the Model")
    ...
    #      st.write(""" The model was last trained at: """)
  ...
  st.image(
    "/content/Organisation_attrition.jpg",
